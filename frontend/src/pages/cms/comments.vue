...
<template>
    <div class = "p-6">
    <h2 class = "text-3xl text-slate-200 px-8 -mb-4">Flagged Comments</h2>
    <div class = "p-1 md:p-8 flex gap-4 flex-wrap">
        <div class = "min-w-[30%] grow" v-for="comment in filterFlaggedComments">
            <div class = "bg-slate-800 text-slate-200 8 m-w-[500px] w-auto h-auto m-auto rounded-xl drop-shadow-2xl shadow-md p-4">
    ...
    <h2 class = "text-3xl text-slate-200 px-8 -mb-4">Comments By Post</h2>
    <div class = "p-1 md:p-8 flex gap-4 flex-wrap">
        <div class = "min-w-[30%] grow" v-for="post in blogPosts">
            <h3 class='text-cyan-500 hover:text-cyan-600 transition-all duration-300 text-xl pb-2'><a :href="post.site + post.subDirectory + post.slug">{{post.title}}</a></h3>
                ...
                <div class = "flex gap-4 flex-wrap">
                    <div class = "min-w-[30%] grow bg-slate-800 text-slate-200 8 m-w-[500px] w-auto h-auto m-auto rounded-xl drop-shadow-2xl shadow-md p-4" v-for="comment in filterCommentsByBlogPost(post._id)">
