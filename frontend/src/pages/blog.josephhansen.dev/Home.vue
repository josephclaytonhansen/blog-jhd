...
<template>
    ...
    <div class="p-8 w-full min-h-screen text-text-1 bg-backdrop-1">
        <h1 class="text-xl lg:text-5xl font-header pt-4 pb-8">Joseph Hansen's development blog and musings</h1>
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-5 lg:gap-8">
            <div>
                <h2 class="text-lg lg:text-3xl font-header pb-3">Recent posts</h2>
            ...
            <div>
                <h2 class="text-lg lg:text-3xl font-header pb-3">Other sites</h2>
                <h3 class="text-lg lg:text-2xl font-header pb-3">My sites</h3>
                ...
                <h3 class="text-lg lg:text-2xl font-header py-3">Blogs I recommend</h3>
                <div class="flex flex-wrap flex-col gap-3">
                    <div class="w-full colorblock rounded p-3">
            ...
            <div>
                <h2 class="text-lg lg:text-3xl font-header pb-3">Since you're here:</h2>
