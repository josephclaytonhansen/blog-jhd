    ...
    <div id="author_box" class="flex item-center rounded-lg w-full p-5 colorblock">
        <div class="flex">
            ...
            <div class="flex flex-col">
                <p class='text-md font-semibold'>by<router-link :to="`/profile/${author.displayName}`" class="hover:text-accent-500 duration-300 transition-all">{{ author.displayName }}</router-link></p>
