...
module.exports = {
    ...
    theme: {
      extend: {
        ...
        backgroundColor: {
          'backdrop-0': process.env.THEME === 'dark' ? 'var(--backdrop-0)' : 'var(--light-backdrop-0)',
          'backdrop-1': process.env.THEME === 'dark' ? 'var(--backdrop-1)' : 'var(--light-backdrop-1)',
        ...
        textColor: {
          'text-0': process.env.THEME === 'dark' ? 'var(--text-text-0)' : 'var(--light-text-0)',
          'text-1': process.env.THEME === 'dark' ? 'var(--text-text-1)' : 'var(--light-text-1)',
