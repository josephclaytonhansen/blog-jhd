...
<template>
    <div class="colorblock_dark w-auto ml-8 rounded-lg p-4 mt-2">
        <div class="w-full flex flex-col items-start">
            ...
            <button @click="replyComment" class="cursor-pointer bg-accent-500 px-5 py-2 rounded-lg text-text-0 hover:bg-accent-600 hover:scale-105 transition-all duration-300">Reply</button>
    </div>
    </div>
</template>