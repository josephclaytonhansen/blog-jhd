                ...
                <div v-for = "user in group.users">
                    <div class="flex items-center gap-3 max-h-8">
                        <div class="flex items-center gap-1 shrink">
                            <Avatar :image="user.picture" classes="ring-4 mr-2 ring-accent-500 hover:cursor-pointer hover:ring-accent-300 transition-all duration-300 avatar" alt="avatar"/>
