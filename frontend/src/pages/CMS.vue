...
<template>
    <div class="w-full h-full flex overflow-hidden">
        <div id="sidebar" class="fixed h-screen overflow-y-hidden bg-backdrop-2 flex flex-col items-start justify-center min-w-[30px] md:min-w-[150px]">
        ...
        <div id="center" class="flex-grow h-full overflow-y-auto bg-backdrop-3 ml-[30px] md:ml-[150px] min-h-[100vh]">
