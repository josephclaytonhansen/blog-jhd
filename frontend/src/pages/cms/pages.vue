...
<template>
    <div class = "p-8 px-20">
        <div class = "font-normal w-full">
            <h1 class="text-2xl text-text-2 pb-3">Pages</h1>
            <h2 class="text-xl text-text-2 pb-2">Creating a new page</h2>
            <p class="text-text-3 pb-2">
                To add a new page, run the following command in the terminal:
                <br/>
                <code class="p-1 rounded-lg bg-backdrop-1 text-accent-500">npm run create-site-page {PageName} {sites?}</code>
                </br></br>
                The sites parameter is optional and can be used to specify the sites that the page should be created for. If it is not set, the page will be created for all sites. To set specific sites, format the parameter as <code class="p-1 rounded-lg bg-backdrop-1 text-accent-500">'["site1","site2"]'</code>.
            </p>
            <h2 class="text-xl text-text-2 pb-2">Editing a page</h2>
            <p class="text-text-3 pb-2">
