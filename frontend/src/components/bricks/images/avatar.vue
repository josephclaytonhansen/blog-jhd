...
<template>
    <div class="overflow-hidden avatar" :class="classes">
        ...
        <div class = "w-full h-full bg-backdrop-500 flex items-center justify-center avatar transition-opacity duration-150 relative -top-[100%]" :class="!imageLoaded ? 'opacity-100' : 'opacity-0'"></div>
    </div>
</template>